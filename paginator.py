...
class SimpleListSource[T](menus.ListPageSource):
    ...
    @overload
    @staticmethod
    async def format_page(_: menus.Menu, entries: list[T]) -> list[T]: ...

    @overload
    @staticmethod
    async def format_page(_: menus.Menu, entries: T) -> T: ...

    @staticmethod
    async def format_page(_: menus.Menu, entries: T | list[T]) -> T | list[T]:
        return entries
